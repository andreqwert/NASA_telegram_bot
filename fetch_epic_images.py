...
from help_functions import download_single_image
import os
import argparse
...
if __name__ == '__main__':
	...
	parser.add_argument('--save_dir', default='./epic_images/', help='Путь для сохранения картинок')
	parser.add_argument('--images_num', default=5, help='Сколько скачивать изображений')
	args = parser.parse_args()

	save_dir = args.save_dir   # './epic_images/'
	images_num = args.images_num   # 5
