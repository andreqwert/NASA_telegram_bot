...
from data_processing import download_single_image, filter_nans
import os
import argparse
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', default='images/epic_images', type=Path, help='Путь для сохранения картинок')
